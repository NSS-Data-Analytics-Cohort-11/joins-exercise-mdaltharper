...
from specs
full join distributors on distributors.distributor_id = specs.domestic_distributor_id
...
select  rating.imdb_rating,specs.lengtgh_in_min
from specs
inner join rating on rating.movie_id = specs.movie_id



SELECT rating.imdb_rating, specs.length_in_min
FROM specs
INNER JOIN rating ON rating.movie_id = specs.movie_id;
